...
<form action="<?php echo $_CB_framework->viewUrl( 'logout', true, null, 'html', $secureForm ); ?>" method="post" id="login-form" class="cbLogoutForm">
	...
	<div class="cblogin-card-square mdl-card mdl-shadow--2dp">
		<div class="user-card-image mdl-card" style="  background: url('<?php echo $cbUser->getField( 'avatar', null, 'text', 'none', 'list', 0, true ); ?>') center / cover;">
		...
		<div class="mdl-card__actions">
			<button type="submit" name="Submit" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" class="button"<?php echo $buttonStyle; ?>>
